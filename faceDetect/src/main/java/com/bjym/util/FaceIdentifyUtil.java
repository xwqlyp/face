...
public class FaceIdentifyUtil {
	//设置APPID/AK/SK
	public static final String APP_ID = "16330147";
	public static final String API_KEY = "upgSk1Q6QLhcC5Tgbl8cH0Ew";
	public static final String SECRET_KEY = "6V7MCvmyYTd4F8C86Eq8WdpL3EGSbd5z";
